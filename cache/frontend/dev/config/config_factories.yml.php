...
$logger = new sfFileLogger($this->dispatcher, array_merge(array('auto_shutdown' => false), array (
  'level' => 'debug',
  'file' => '/opt/lampp/htdocs/rs12/log/frontend_dev.log',
)));
$this->factories['logger']->addLogger($logger);
  ...
  'cache_dir' => '/opt/lampp/htdocs/rs12/cache/frontend/dev/i18n',
  'lifetime' => 31556926,
  'prefix' => '/opt/lampp/htdocs/rs12/apps/frontend/i18n',
));
...
'auto_shutdown' => false, 'session_id' => $this->getRequest()->getParameter('symfony'),
  ...
  'automatic_cleaning_factor' => 0,
  'cache_dir' => '/opt/lampp/htdocs/rs12/cache/frontend/dev/template',
  'lifetime' => 86400,
  'prefix' => '/opt/lampp/htdocs/rs12/apps/frontend/template',
)));
