 ...
 */
class myWidgetFormI18nChoiceLanguageOpcionOwnLanguage extends sfWidgetFormChoice
{
  /**
   * Constructor.
   *
  ...
  protected function configure($options = array(), $attributes = array())
  {
    ...
    $this->addOption('own_languages', true);


    if($this->getOption('own_languages')){

        foreach($options['languages'] as $language)
        {
            $languages[$language] = sfCultureInfo::getInstance($language)->getLanguage(isset($language) ? $language : null);
        }
