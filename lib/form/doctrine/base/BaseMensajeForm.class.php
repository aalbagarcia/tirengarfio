...
abstract class BaseMensajeForm extends BaseFormDoctrine
{
  public function setup()
  {
    ...
    $this->setValidators(array(
      ...
      'sf_guard_user_profile_id' => new sfValidatorDoctrineChoice(array('model' => $this->getRelatedModelName('sfGuardUserProfile'), 'required' => false)),
      'receptor'                 => new sfValidatorInteger(array('required' => false)),
      'tipo'                     => new sfValidatorInteger(array('required' => false)),
      'titulo'                   => new sfValidatorString(array('max_length' => 100)),
      'contenido'                => new sfValidatorString(array('max_length' => 4000)),
