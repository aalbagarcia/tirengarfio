 ...
 * @version    SVN: $Id: sfFormLanguage.class.php 24750 2009-12-02 05:30:21Z Jonathan.Wage $
 */
class sfFormLanguage extends sfForm
{
  ...
  public function configure()
  {
    ...
    $this->setWidgets(array(
      'language' => new myWidgetFormI18nChoiceLanguageOpcionOwnLanguage(array('languages' => $this->options['languages'])),
    ));
    
    $this->widgetSchema->setLabel('language', false);
  }
}
